...
flags.DEFINE_list('images', 'tempimg.jpg', 'path to input image')
...
def main(_argv):
    ...
    for count, image_path in enumerate(images, 1):
        original_image = cv2.imread('tempimg.jpg')
        # print(image_path)
        ...
        if FLAGS.count:
            ...
            if "bottle" in counted_classes:
                write_value = counted_classes.get('bottle')
            else:
                write_value = 100
            with open("Output.txt", "w") as text_file:
                text_file.write(str(write_value))
            # print(counted_classes.get('bottle'))
